...
class UserRegistrationForm(UserCreationForm):
    ...
    confirming_password = forms.CharField(label='Equip Password', )#widget=forms.PasswordInput(attrs={'class': 'form-control'}))

    class Meta:
        model = User
        fields = ('username', 'email', 'password', 'confirming_password')